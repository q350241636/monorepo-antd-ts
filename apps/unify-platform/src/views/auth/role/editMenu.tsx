...
function EditMenu(props: EditMenuProps) {
  ...
  const onCheck = useCallback((keys: ReactText[] | { checked: ReactText[]; halfChecked: ReactText[] }) => {
  ...
  return (
    <Modal maskClosable={false} visible={visible} title="编辑角色权限" onCancel={props.onClose} onOk={onOk}>
      <Form
        form={form}
        initialValues={role || {}}
        labelCol={{
