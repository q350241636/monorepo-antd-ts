  ...
  return (
    <FormInputItem
      ...
      rules={[
        ...
        {
          validator: (_rules: Record<string, unknown>[], value: string, callback: (message?: string) => void) => {
...
function Code(props: LoginItemProps) {
  ...
  return <FormInputItem formProps={{ children: null }} {...config.Code} {...props} onGetMobileCode={onGetMobileCode} />
}
