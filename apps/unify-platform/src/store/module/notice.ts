...
export const clearNoticeByKey: (key: keyof NoticeState) => IAction<keyof NoticeState> = (key: keyof NoticeState) => ({
...
// eslint-disable-next-line no-unused-vars
export const readNoticeByKeyAndIndex: (payload: NoticeKeyAndIndexAndCount) => IAction<NoticeKeyAndIndexAndCount> = (
...
const noticeReducer: Reducer<NoticeState, IAction<any>> = (state = defaultUser, action: IAction<any>) => {
